...
import com.cafedev.api.CafePosApplication;
...
public class StartPOS {
  ...
  public static void main(final String args[]) {
    ...
    // Inicia el servidor embebido de Spring Boot: CafeDev3
    Thread cafePosApiThread = new Thread(() -> {
      SpringApplicationBuilder builder = new SpringApplicationBuilder(CafePosApplication.class);
      builder.headless(false).run(args);
    });
    cafePosApiThread.start();
