...
// primary DB
    ...
    m_propsconfig.setProperty("db.schema", "jcfposdb");
...
// secondary DB        
    ...
    m_propsconfig.setProperty("db1.schema", "jcfposdb");
    ...
    m_propsconfig.setProperty("tkt.footer2", "Gracias");
    m_propsconfig.setProperty("tkt.footer3", "Llama de nuevo");
