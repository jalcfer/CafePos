...
INSERT INTO ROLES(id, name, permissions) VALUES('0', 'Administrador', $FILE{/com/openbravo/pos/templates/Role.Administrator.xml} );
INSERT INTO ROLES(id, name, permissions) VALUES('1', 'Gerente', $FILE{/com/openbravo/pos/templates/Role.Manager.xml} );
INSERT INTO ROLES(id, name, permissions) VALUES('2', 'Empleado', $FILE{/com/openbravo/pos/templates/Role.Employee.xml} );
INSERT INTO ROLES(id, name, permissions) VALUES('3', 'Invitado', $FILE{/com/openbravo/pos/templates/Role.Guest.xml} );
/* Header line. Object: vouchers. Script date: 08/05/2016 18:00:00. */
CREATE TABLE people (
    id VARCHAR NOT NULL,
    name VARCHAR NOT NULL,
...
INSERT INTO taxcategories(id, name) VALUES ('000', 'Exento de Impuestos');
INSERT INTO taxcategories(id, name) VALUES ('001', 'Impuestos Estandar');
...
INSERT INTO TAXES(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('001', 'Iva19', '001', NULL, NULL, 0.19, false, NULL);
INSERT INTO TAXES(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('002', 'Iva5', '001', NULL, NULL, 0.05, false, NULL);
INSERT INTO TAXES(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('003', 'Impoconsumo', '001', NULL, NULL, 0.08, false, NULL);
...
VALUES ('xxx999_999xxx_x9x9x9', 'xxx999', 'xxx999', 'Producto 1', '000', '001', false, '<html><center>Producto 1', '1');
INSERT INTO products(id, reference, code, name, category, taxcat, isservice, display, printto) 
VALUES ('xxx998_998xxx_x8x8x8', 'xxx998', 'xxx998', 'Producto 2', '000', '001', true, '<html><center>Producto 2', '1');
...
INSERT INTO floors(id, name, image) VALUES ('0', 'Piso Restaurante', $FILE{/com/openbravo/pos/templates/restaurant_floor.png});
...
INSERT INTO places(id, name, x, y, floor) VALUES ('1', 'Mesa 1', 80, 70, '0');
INSERT INTO places(id, name, x, y, floor) VALUES ('2', 'Mesa 2', 250, 75, '0');
INSERT INTO places(id, name, x, y, floor) VALUES ('3', 'Mesa 3', 400, 75, '0');
INSERT INTO places(id, name, x, y, floor) VALUES ('4', 'Mesa 4', 80, 200, '0');
INSERT INTO places(id, name, x, y, floor) VALUES ('5', 'Mesa 5', 260, 210, '0');
INSERT INTO places(id, name, x, y, floor) VALUES ('6', 'Mesa 6', 430, 210, '0');
INSERT INTO places(id, name, x, y, floor) VALUES ('7', 'Mesa 7', 80, 330, '0');
INSERT INTO places(id, name, x, y, floor) VALUES ('8', 'Mesa 8', 190, 350, '0');
INSERT INTO places(id, name, x, y, floor) VALUES ('9', 'Mesa 9', 295, 350, '0');
INSERT INTO places(id, name, x, y, floor) VALUES ('10', 'Mesa 10', 430, 345, '0');
INSERT INTO places(id, name, x, y, floor) VALUES ('11', 'Mesa 11', 550, 135, '0');
INSERT INTO places(id, name, x, y, floor) VALUES ('12', 'Mesa 12', 550, 290, '0');
