...
# start uniCenta oPOS
java -cp $CP -Dlogging.level=INFO -Xms512m -Xmx1024m -splash:jPOS_splash_dark.png -Djava.library.path=$DIRNAME$LIBRARYPATH -Ddirname.path=$DIRNAME/ com.openbravo.pos.forms.StartPOS